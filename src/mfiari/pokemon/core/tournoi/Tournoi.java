...
public class Tournoi extends ControlleurVue {
    ...
    protected Terrain terrainDuCombat;
    private String nom;
    ...
    protected Dresseur dress1;
    protected Dresseur dress2;
    ...
    private void combat (Dresseur d1, Dresseur d2) {
        ...
        if (this.aventure) {
            c.commencerCombat(new ListeDeDresseur(d1), new ListeDeDresseur(d2), Combat.TypeCombat.SIMPLE);
        } else {
            c.commencerCombat(new ListeDeDresseur(d1), new ListeDeDresseur(d2), Combat.TypeCombat.SIMPLE);
        }*/
    }
