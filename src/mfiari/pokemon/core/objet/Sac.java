...
public class Sac extends mfiari.lib.game.objet.Sac implements Serializable {
    ...
    private final ListeObjet<Objet_divers> objets_divers;
    private final ListeObjet<Objet_medicament> objets_medicament;
    private final ListeObjet<Objet_ball> objets_ball;
    private final ListeObjet<Objet_capacite> objets_capacite;
    private final ListeObjet<Objet_baie> objets_baie;
    private final ListeObjet<Objet_lettre> objets_lettre;
    private final ListeObjet<Objet_combat> objets_combat;
    private final ListeObjet<Objet_rare> objets_rare;
