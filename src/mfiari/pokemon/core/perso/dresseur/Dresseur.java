...
import mfiari.pokemon.core.tournoi.StatTournoi;
 ...
 * @author mike
 */
abstract public class Dresseur extends Personnage {
    ...
    public boolean aPokemon () {
        for (int i=0 ; i< this.equipe.lenght() ; i++) {
            if (this.equipe.getPokemon(i) != null && !this.equipe.getPokemon(i).estKo()) {
                return true;
            }
        }
        return false;
