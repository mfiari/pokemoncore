...
import mfiari.pokemon.core.objet.ObjetEndroitPassage;
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("endroit")) {
            ...
            if ("maison".equals(typeBatiment)) {
                Maison maison = new Maison("maison", positionx, positiony, 1, 1, 1, Orientation.face, this.quartier, false);
                this.quartier.ajouterBatiment(maison);
            } else if ("labo".equals(typeBatiment)) {
                Batiment labo = new Batiment("Labo du prof", positionx, positiony, 1, 1, 0, 1,Orientation.face,  this.quartier, TypeBatiment.labo);
